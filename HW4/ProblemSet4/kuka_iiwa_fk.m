function [pos] = kuka_iiwa_fk( theta_1, theta_2, theta_3, theta_4, theta_5, theta_6, theta_7, l)
%    kuka_iiwa_fk The input to the function will be the joint
...
%    in the question.
%    pos - 13 x 3 matrix with position of different frames and the position of
%    the gripper.
if nargin < 8
   l = 0.2;
end
...
% Construct the full DH parameter table (should be size 7x4)

dhparams = zeros(7,4);
dhparams(:,:) = [0	pi/2    0.15	theta_1;
                 0  -pi/2   0       theta_2;
                 0  pi/2    0.45    theta_3;
                 0  -pi/2   0       theta_4 - pi/2;
                 0  pi/2    0.35    theta_5;
                 0  pi/2    0       theta_6 + pi/2;
                 0  0       0.25    theta_7];
...
A7 = A6 * compute_dh_matrix(dhparams(7,1), dhparams(7,2), dhparams(7,3), dhparams(7,4));
...
pseudoPos(8,:) = A7 * [0;0;0;1];
pos(8,:) = pseudoPos(8,1:3);

% Represent the gripper points in different frames

pseudoPos(9,:) = A7 * [grip_1(1);grip_1(2);grip_1(3);1];
pos(9,:) = pseudoPos(9,1:3);

pseudoPos(10,:) = A7 * [grip_2(1);grip_2(2);grip_2(3);1];
pos(10,:) = pseudoPos(10,1:3);

pseudoPos(11,:) = A7 * [grip_3(1);grip_3(2);grip_3(3);1];
pos(11,:) = pseudoPos(11,1:3);

pseudoPos(12,:) = A7 * [grip_4(1);grip_4(2);grip_4(3);1];
pos(12,:) = pseudoPos(12,1:3);

pseudoPos(13,:) = A7 * [grip_5(1);grip_5(2);grip_5(3);1];
pos(13,:) = pseudoPos(13,1:3);
...
% Compute Matrix from DH Parameters
A = zeros(4,4);
